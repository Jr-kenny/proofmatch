...
class ProofmatchContract(gl.Contract):
    case_count: u256
...
"""
        ...
        case_json = gl.eq_principle.prompt_comparative(
            build_assessment,
